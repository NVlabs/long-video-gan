...
def compute_fid(opts, max_real, num_gen, use_image_dataset=True, num_frames=1, subsample_factor: int=1):
    ...
    mu_real, sigma_real = metric_utils.compute_feature_stats_for_dataset(
        ...
        rel_lo=0, rel_hi=0, capture_mean_cov=True, max_items=max_real, use_image_dataset=use_image_dataset).get_mean_cov()
    ...
    mu_gen, sigma_gen = compute_gen_stats_fn(
        ...
        rel_lo=0, rel_hi=1, capture_mean_cov=True, max_items=num_gen, use_image_dataset=use_image_dataset, **gen_kwargs).get_mean_cov()
