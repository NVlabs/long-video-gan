    ...
    *,
    ...
    for step in range(start_step, total_steps + 1):
            ...
            if tick % ticks_per_G_ema_ckpt == 0:
                ...
                if rank == 0:
                    with torch.inference_mode():
                        hr_video = misc.print_module_summary(video_gan.G, [print_lr_video])
                        misc.print_module_summary(video_gan.D, [video_gan.crop_to_seq_length(print_lr_video), hr_video])
                ...
                with torch.no_grad():
                    ...
                    segments = G_ema_ckpt.sample_video_segments(result_lr_video, generator_z=generator)
        ...
        if step % r1_interval == 0:
            ...
            hr_video = video_gan.crop_to_seq_length(sample["hr_video"]).cuda()
            video_gan.update_r1(lr_video, hr_video, gain=r1_interval)
